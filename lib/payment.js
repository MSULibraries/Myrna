...
export class Payment {
  ...
  createUrl(amountDue, orderNumber, timestamp) {
    ...
    const redirectUrl = 'localhost:3000/payment/success';
    ...
    const url = `${this
      .paymentEndpoint}orderNumber=${orderNumber}&orderType=${orderType}&amountDue=${amountDue}&paymentMethod=${paymentMethod}&redirectUrlParameters=${redirectUrlParameters}&retriesAllowed=${retriesAllowed}&timestamp=${timestamp}&hash=${hash}`;
