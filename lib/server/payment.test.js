    ...
    describe('createUrl', () => {
      ...
      it('returns a url with correct params', () => {
        ...
        const noHashUrl = `${Meteor.settings.private.payment
          .endpoint}orderNumber=${orderNumber}&orderType=${orderType}&amountDue=${amountDue}&paymentMethod=${paymentMethod}&redirectUrl=${redirectUrl}&redirectUrlParameters=${redirectUrlParameters}&timestamp=${timestamp}`;
